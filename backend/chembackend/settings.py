"""
Django settings for chembackend project.
...
WSGI_APPLICATION = 'chembackend.wsgi.application'
...
# Replace 'default' database configuration with Supabase (PostgreSQL) if DATABASE_URL is present
